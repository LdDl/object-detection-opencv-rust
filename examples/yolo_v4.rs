...
fn main() {
    ...
    let mut model = ModelYOLOClassic::new_from_file("pretrained/yolov4.weights", Some("pretrained/yolov4.cfg"), (net_width, net_height), mf, DNN_BACKEND_CUDA, DNN_TARGET_CUDA, vec![]).unwrap();
    ...
    imwrite("images/dog_yolov4.jpg", &frame, &Vector::new()).unwrap();
}
