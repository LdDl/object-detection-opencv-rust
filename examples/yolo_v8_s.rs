...
fn main() {
    ...
    let mut model = ModelUltralyticsV8::new_from_file("pretrained/yolov8s.onnx", None, (net_width, net_height), mf, DNN_BACKEND_CUDA, DNN_TARGET_CUDA, vec![]).unwrap();
    ...
    imwrite("images/dog_yolov8_s.jpg", &frame, &Vector::new()).unwrap();
}