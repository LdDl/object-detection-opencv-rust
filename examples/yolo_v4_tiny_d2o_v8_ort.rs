//! YOLOv4-tiny converted from Darknet via darknet2onnx (--format yolov8)
//! Output format: [1, 84, -1] without objectness score (ultralytics layout)
...
fn main() {
    ...
    let mut model = Model::ort(
        "pretrained/yolov4-tiny-d2o-v8.onnx",
