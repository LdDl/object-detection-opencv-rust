...
fn main() {
    ...
    let mut model = Model::opencv("pretrained/yolo11s.onnx", (net_width, net_height), DnnBackend::Cuda, DnnTarget::Cuda).unwrap();
    ...
    imwrite("images/dog_yolov11_s.jpg", &frame, &Vector::new()).unwrap();
}
