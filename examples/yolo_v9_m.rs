...
fn main() {
    ...
    let mut model = Model::opencv("pretrained/yolov9m.onnx", (net_width, net_height), DnnBackend::Cuda, DnnTarget::Cuda).unwrap();
    ...
    imwrite("images/dog_yolov9_m.jpg", &frame, &Vector::new()).unwrap();
}
