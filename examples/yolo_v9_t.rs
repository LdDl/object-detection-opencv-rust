...
fn main() {
    ...
    let mut model = Model::opencv("pretrained/yolov9t.onnx", (net_width, net_height), DnnBackend::Cuda, DnnTarget::Cuda).unwrap();
    ...
    imwrite("images/dog_yolov9_t.jpg", &frame, &Vector::new()).unwrap();
}
