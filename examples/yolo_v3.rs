...
fn main() {
    ...
    let mut model = ModelYOLOClassic::new_from_file("pretrained/yolov3.weights", Some("pretrained/yolov3.cfg"), (net_width, net_height), mf, DNN_BACKEND_CUDA, DNN_TARGET_CUDA, vec![]).unwrap();
    ...
    imwrite("images/dog_yolov3.jpg", &frame, &Vector::new()).unwrap();
}
